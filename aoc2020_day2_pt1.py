...
valid_password_numbers = 0 


for passwords in password_list:
    character_count = 0
    print(f"This is the line {passwords}.")
    details = passwords.split(" ")
    print(f"The min and max are {details[0]}, the letter is {details[1]} and the password is {details[2]}.")
    min_and_max = details[0].split("-") #makes a list
    minimum = int(min_and_max[0])
    maximum = int(min_and_max[1])
    password = details[2]
    print(f"The min is {minimum} and the max is {maximum}.")
    ...
    if minimum <= character_count and maximum >= character_count:
        valid_password_numbers += 1
         
print(valid_password_numbers)
