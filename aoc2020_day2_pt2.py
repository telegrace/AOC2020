password_list = """14-15 v: vdvvvvvsvvvvvfpv
...
for line in password_list:
    details = line.split(" ") #splits at the spaces
    indexes = (details[0]).split("-")
    #print(indexes)
    first_index_to_check = int(indexes[0])-1
    #print(first_index_to_check)
    second_index_to_check = int(indexes[1])-1
    letter = (details[1]).replace(":", "")
    password = details[2]
    print(f"The given letter is, {letter}, and the letter at index {first_index_to_check} is {password[first_index_to_check]} and the letter at index {second_index_to_check} is {password[second_index_to_check]}.")
    if letter == password[first_index_to_check] and letter != password[second_index_to_check] or letter != password[first_index_to_check] and letter == password[second_index_to_check]:
        valid_passwords += 1
        print(f"{password} is an VALID password. There are {valid_passwords} valid passwords.\n")
    else: 
        invalid_passwords += 1
        print(f"{password} is an INVALID password. There are {valid_passwords} valid passwords.\n")


print(f"There are {valid_passwords} valid passwords.")
print(f"There are {invalid_passwords} INVALID passwords.")
print(f"Altogether there were {valid_passwords + invalid_passwords} passwords.")
