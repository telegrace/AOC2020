...
ecl:hzl hgt:181cm byr:1980 hcl:#341e13 eyr:2028""" # passport input
...
for passport in passport_list:  
    ...
    for detail in passport_details:
        ...
        while i < len(requirements):
            print(f"Cross checking {information} with {requirements[i]}.")
            if information == requirements[i]:
                print(f"MATCH FOUND! This information matches {requirements[i]}.")
                valid_info += 1
                print(f"This is the amount of valid info {valid_info}")
                i += 1
                break
            else:
                i += 1
        ...
        if valid_info == 7: 
            print(f"The passport, {passport_details}, is valid.")
            valid_passports += 1 
        else:
            invalid_passport += 1
            
print(f"There are {len(passport_list)} passports, {invalid_passport} are invalid and {valid_passports} are valid.")